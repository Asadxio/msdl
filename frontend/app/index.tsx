...
import { COLORS, SPACING, RADIUS, SHADOWS, COURSES, TEACHERS, MEDIA } from '@/constants/theme';
      ...
      >
        ...
        <View style={styles.section}>
          ...
          >
            {featuredCourses.map((course, index) => (
              ...
              >
                <Image
                  source={{ uri: index % 2 === 0 ? MEDIA.coursePlaceholder1 : MEDIA.coursePlaceholder2 }}
        ...
        <View style={styles.section}>
          ...
          >
            {TEACHERS.map((teacher, index) => (
              ...
              >
                <Image
                  source={{ uri: index === 0 ? MEDIA.teacherAvatar1 : MEDIA.teacherAvatar2 }}
        ...
        <View style={[styles.section, { paddingHorizontal: SPACING.lg }]}>
          ...
          <View style={styles.announcementCard} testID="announcement-card">
            <Image
              source={{ uri: MEDIA.lanternIcon }}
              style={styles.lanternIcon}
            />
            <LinearGradient
              colors={[COLORS.primary, '#0A2B1A']}
