...
const styles = StyleSheet.create({
  ...
  input: {
    borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.xxl,
  ...
  sendBtn: { backgroundColor: COLORS.primary, borderRadius: RADIUS.xxl, paddingVertical: 12, alignItems: 'center' },
  ...
  card: { backgroundColor: COLORS.surface, borderRadius: RADIUS.xxl, padding: SPACING.md, ...SHADOWS.card, overflow: 'hidden' },
