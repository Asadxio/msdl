...
const styles = StyleSheet.create({
  ...
  btn: { flex: 1, backgroundColor: COLORS.primary, borderRadius: RADIUS.xxl, alignItems: 'center', justifyContent: 'center', paddingVertical: 12 },
  btnText: { color: '#fff', fontWeight: '700' },
  secondaryBtn: { flex: 1, borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.xxl, alignItems: 'center', justifyContent: 'center', paddingVertical: 12, backgroundColor: COLORS.surface },
