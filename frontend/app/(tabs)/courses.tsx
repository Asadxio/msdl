...
const styles = StyleSheet.create({
  ...
  courseName: { ...TYPOGRAPHY.heading, fontSize: 18, color: COLORS.textMain, fontWeight: '800', lineHeight: 24 },
  teacherRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  teacherName: { ...TYPOGRAPHY.body, color: COLORS.textMuted, flex: 1, fontSize: 13, fontWeight: '600' },
  ...
  attendBtnText: { color: COLORS.primary, fontSize: 14, fontWeight: '800' },
