...
const MENU_SECTIONS: MenuSection[] = [
  {
    ...
    colorIcon: '#4F46E5',
    items: [
      { label: 'Dar-ul-Iftaa (Fatwa Library)', subtitle: 'Private Islamic questions & official fatwa library', icon: 'ribbon-outline', route: '/fatawa', colorBg: '#FEF3C7', colorIcon: '#D97706' },
      { label: 'Islamic Flashcards', subtitle: 'Memorize Duas, Hadiths & Fiqh rules', icon: 'card-outline', route: '/flashcards', colorBg: '#ECFDF5', colorIcon: '#059669' },
      { label: 'The Holy Quran (Roman Urdu)', subtitle: 'Read, Khatam & Hifz tracker — exclusive Roman Urdu!', icon: 'book-outline', route: '/quran', colorBg: '#FFF7ED', colorIcon: '#C8A84E' },
  ...
  },
  {
    ...
    colorIcon: '#10B981',
    items: [
      { label: 'Taharat & Purity Tracker', subtitle: '100% Private Islamic purity & habit tracker', icon: 'heart-outline', route: '/taharat-tracker', colorBg: '#FDF2F8', colorIcon: '#DB2777' },
      { label: 'AI Sabaq Assistant', subtitle: '24/7 Islamic study & vocabulary assistant', icon: 'sparkles-outline', route: '/ai-assistant', colorBg: '#F0FDF4', colorIcon: '#16A34A' },
      { label: 'Sadqah-e-Jariyah & Referral', subtitle: 'Invite sisters to madrasa & earn rewards', icon: 'gift-outline', route: '/referral', colorBg: '#FDF2F8', colorIcon: '#DB2777' },
      ...
      { label: 'Certificates & Sanad', subtitle: 'View your certificates', icon: 'ribbon-outline', route: '/(tabs)/certificate', colorBg: '#F5F3FF', colorIcon: '#7C3AED' },
      { label: 'Verify Sanad Online', subtitle: 'Verify official certificate online', icon: 'shield-checkmark-outline', route: '/verify-sanad', colorBg: '#ECFDF5', colorIcon: '#059669' },
