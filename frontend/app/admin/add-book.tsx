...
const styles = StyleSheet.create({
  ...
  seedBtn: {
    ...
    backgroundColor: COLORS.primary, paddingVertical: SPACING.lg, borderRadius: RADIUS.xxl, ...SHADOWS.card,
  },
  ...
  smallBtn: { backgroundColor: COLORS.primary, borderRadius: RADIUS.xxl, paddingHorizontal: 14, paddingVertical: SPACING.md },
  smallBtnText: { color: '#fff', fontWeight: '700' },
  saveBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    backgroundColor: COLORS.primary, paddingVertical: SPACING.lg, borderRadius: RADIUS.xxl,
  },
