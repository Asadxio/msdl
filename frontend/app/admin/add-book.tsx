...
const styles = StyleSheet.create({
  ...
  seedBtn: {
    ...
    backgroundColor: COLORS.primary, paddingVertical: 16, borderRadius: RADIUS.xxl, ...SHADOWS.card,
  },
  ...
  input: {
    ...
    borderRadius: RADIUS.xxl, paddingHorizontal: SPACING.md, paddingVertical: 14,
  ...
  smallBtn: { backgroundColor: COLORS.primary, borderRadius: RADIUS.xxl, paddingHorizontal: 14, paddingVertical: 12 },
  smallBtnText: { color: '#fff', fontWeight: '700' },
  saveBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    backgroundColor: COLORS.primary, paddingVertical: 16, borderRadius: RADIUS.xxl,
  },
