...
const styles = StyleSheet.create({
  ...
  searchInput: {
    backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.xxl,
  ...
  approveBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: COLORS.success, paddingHorizontal: 14, paddingVertical: 8, borderRadius: RADIUS.xxl, marginLeft: 'auto' },
  approveBtnText: { color: '#FFF', fontSize: 13, fontWeight: '700' },
  rejectBtn: { borderWidth: 1, borderColor: COLORS.error, paddingHorizontal: 14, paddingVertical: 7, borderRadius: RADIUS.xxl, marginLeft: 'auto' },
  rejectBtnText: { color: COLORS.error, fontSize: 13, fontWeight: '600' },
  deactivateBtn: { borderWidth: 1, borderColor: COLORS.error, paddingHorizontal: 12, paddingVertical: 7, borderRadius: RADIUS.xxl },
  deactivateBtnText: { color: COLORS.error, fontSize: 12, fontWeight: '600' },
  reactivateBtn: { backgroundColor: '#E3F2FD', paddingHorizontal: 14, paddingVertical: 8, borderRadius: RADIUS.xxl, marginLeft: 'auto' },
