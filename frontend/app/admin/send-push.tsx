...
const styles = StyleSheet.create({
  ...
  searchAvatar: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#ddd' },
  searchAvatarPlaceholder: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#eee', alignItems: 'center', justifyContent: 'center' },
