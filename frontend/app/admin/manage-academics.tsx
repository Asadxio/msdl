...
const styles = StyleSheet.create({
  ...
  primaryBtn: { backgroundColor: COLORS.primary, borderRadius: RADIUS.xxl, paddingVertical: 12, alignItems: 'center', marginTop: 2 },
  primaryBtnText: { color: '#fff', fontWeight: '700' },
  secondaryBtn: { borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.xxl, paddingVertical: 10, alignItems: 'center' },
