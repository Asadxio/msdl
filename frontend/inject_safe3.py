...
inject_safe('app/(tabs)/notifications.tsx', '')
inject_safe('app/(tabs)/progress.tsx', '')
inject_safe('app/(tabs)/attendance.tsx', '')
inject_safe('app/(tabs)/certificate.tsx', 'if (typeof refetch !== \'undefined\') await refetch();')
