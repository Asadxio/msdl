// Complete 114 Surah Audio Filenames for Archive.org Collection
// Item: quran-arabic-to-urdu-hindi-verse-by-verse-tarjuma-audio

export const QURAN_AUDIO_FILENAMES: string[] = [
  ...
  "009-At-taubahTheRepentance-.mp3",
